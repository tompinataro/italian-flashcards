const decks = [
  {
    ...
    cards: [
      ...
      { front: 'come stai?', back: 'how are you?', note: 'Informal.' },
      { front: 'sto bene, grazie', back: "I'm well, thanks" },
      { front: 'va bene', back: 'all right / okay' },
      { front: 'perfetto', back: 'perfect' },
      { front: 'andiamo', back: "let's go" },
      { front: 'piano piano', back: 'little by little / slowly' },
      { front: 'capito', back: 'understood / got it' },
